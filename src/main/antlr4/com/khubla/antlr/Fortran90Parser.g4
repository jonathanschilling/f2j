/*	
 * Fortran 90 grammar for Antlr 4
 * Based on the Fortran 77 grammar for ANTLR 2.7.5
 ...
 * Fortran 90 additions by Jonathan Schilling, 2020
 */
...
doStatement
   : DO (doWithLabel | doWithEndDo | doWhile)
   ;

doWhile
   : WHILE LPAREN logicalExpression RPAREN EOL? doBody EOL? enddoStatement
   ;
